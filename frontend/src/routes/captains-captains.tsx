...
for (const match of data) {
  ...
  if (
    ...
    match["North picks"].filter((player) => player != match["Captain North"]);
  }
  if (
    match["South picks"].includes(match["Captain South"])
  ) {
    match["South picks"].filter((player) => player != match["Captain South"]);
  }
